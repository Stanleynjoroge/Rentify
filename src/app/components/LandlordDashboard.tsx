      ...
      <div className="container mx-auto px-4 py-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-5 mb-6">
            <TabsTrigger value="rent-status" className="flex-col gap-1 h-auto py-2">
              <DollarSign className="h-4 w-4" />
              <span className="text-xs">Rent</span>
            </TabsTrigger>
            <TabsTrigger value="properties" className="flex-col gap-1 h-auto py-2">
              <Building2 className="h-4 w-4" />
              <span className="text-xs">Properties</span>
            </TabsTrigger>
            <TabsTrigger value="units" className="flex-col gap-1 h-auto py-2">
